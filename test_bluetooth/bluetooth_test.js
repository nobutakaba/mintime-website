...
scanButton.addEventListener('click', async () => {
    ...
    try {
        ...
        if (error.name === 'NotFoundError') {
            ...
            resultElement.innerHTML = `<p style="color: red;"><strong>エラーが発生しました:</strong> Connection Error: Connection attempt failed. (テレビの再起動や設定の確認が必要です)</p>`;
        } else {
